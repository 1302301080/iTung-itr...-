...
{ $Id: custom.js,v 1.3 2016/10/27 08:42:07 leowong Exp $ Copyright 2000-2016 eBroker Systems Ltd. }
*/
...
router.get('/', control.isAuthenticated, function (req, res) {
    ...
    res.render(__views_path + 'iTrader/custom/container', {
        layout: __views_path + 'iTrader/custom/layout',
