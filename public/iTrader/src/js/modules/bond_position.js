...
{ $Id: bond_position.js,v 1.5 2017/11/06 09:34:03 leowong Exp $ Copyright 2000-2017 eBroker Systems Ltd. }
*/

define(function (require, exports, module) {
    var name = 'bond_position'
    var container
    var setting
    var table
    var datatable
    exports.init = function (c, s) {
        ...
        if (!setting) return
        table = container.find('#bond-position-table')
        ...
        PositionMgr.on(function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (IsOTCBond(obj)) {
                    ...
                    newObj.DT_RowId = 'bond-position-' + obj[0]
    ...
    function draw() {
        datatable = table.CreateDatatable({
            columnSchema: setting.full_trade.bond.schema,
            order: [0, 'asc'],
            aoColumnDefs: [
